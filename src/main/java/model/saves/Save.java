...
import model.quests.QuestParser;
    ...
    public static void parseCharacters(Game game, File file) throws IOException
    {
        ...
        while ((line = br.readLine()) != null)
        {
            if(!line.isEmpty() && line.charAt(0) == 'C')
            {
                ...
                //info, attributes, equipped model.items
                for (int i = 0; i < 4; i++)
                {
                    name = br.readLine();
...
//            {
//                if(district.getEnemies() != null)
//                {
//                    newInfo.append(district.getEnemies().size()).append("\n");
//
