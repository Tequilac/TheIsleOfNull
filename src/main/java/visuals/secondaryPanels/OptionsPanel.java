...
public class OptionsPanel extends SecondaryPanel
{
    ...
    public OptionsPanel(Game game, Frame frame)
    {
        ...
        hitButton = new JButton(new ImageIcon("src/main/resources/graphics/hit.png"));
        ...
        inventoryButton = new JButton(new ImageIcon("src/main/resources/graphics/backpack.png"));
        ...
        optionsButton = new JButton(new ImageIcon("src/main/resources/graphics/options.png"));
