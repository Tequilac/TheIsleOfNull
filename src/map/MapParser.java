...
public class MapParser
{
    ...
    {
        JsonElement jsonElement = JsonParser.parseReader(new FileReader("res/maps/" + filename + ".json"));
        ...
        BufferedReader br = new BufferedReader(new FileReader("res/maps/" + filename + ".txt"));
